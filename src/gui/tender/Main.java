...
public class Main extends JavaPlugin {
    ...
    public static VHandler vHandler;

    public void onEnable() {

        vHandler = new VHandler(getServer().getVersion());
        a();
        Inventory inventoryMain = new CreateMain().create();
        tender = new Tender(getDataFolder(), economy, vHandler, inventoryMain);
        ...
        getServer().getPluginManager().registerEvents(new InventoryClick(getDataFolder(), inventoryMain, economy), this);
